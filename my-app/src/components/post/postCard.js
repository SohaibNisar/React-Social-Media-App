...
class Post extends Component {
  ...
  render() {
    ...
    let deleteButton =
      post && credentials ? post.userHandle === credentials.userHandle : false;
    return (
      <>
        <Root>
          <CardHeader
            avatar={<Avatar alt={post.userHandle} src={post.profilePicture} />}
            action={
            ...
            title={
              <MuiLink
                ...
                sx={{ fontWeight: "bold", color: "#009688 !important" }}
              >
                {post.userHandle}
              </MuiLink>
            }
